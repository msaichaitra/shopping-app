...
//         updateError(errorList = [...errorList]);     //update error message in state   //spread operator?
//         if(formstatus == false){
...
//                     <i className="text-danger"> All Feilds are Mandatory !</i>
...
const Mynewproduct = () =>{
    ...
    const save = () =>{
        ...
        updateError(errorList = [...errorList]); // update error message in state
